...
class PelotonClient:
    ...
    def _init_session(self):
        ...
        if response.status_code != 200:
            raise ValueError("Session authorization failed. Check credential validity.")
    ...
    def fetch_workouts(self, limit=10, fetch_all=False, page=0):
        ...
        response = self._call_api(request_uri, request_parameters, fetch_all=fetch_all)
    ...
    def fetch_user_achievements(self):
        ...
        for response_data in response:
            ...
            for achievement_category in achievement_categories:
                achievements.append(
                    {
                        "type": achievement_category.get("slug"),
                        "achievements": achievement_category.get("achievements"),
                    }
                )
